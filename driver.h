...
public:
    ...
    Driver(const QString& firstName, QString& lastName, const bool gender, const QDate& born_date, const Position& position,
           const QString& email, const QString& phone): Person(firstName, lastName, gender, born_date),
